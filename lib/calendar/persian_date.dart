...
/// A date in the Persian (Solar Hijri) astronomical calendar.
class PersianDate extends ILibCalendarDate {
  ...
  void _decomposeRd(double rd) {
    ...
    if (dayOfYear <= 186) {
      ...
      _day = dayOfYear - PersianRataDie.cumMonthLengths[_month - 1];
    }
  ...
  @override
  int getDayOfYear() {
    return PersianRataDie.cumMonthLengths[_month - 1] + _day;
  }
  ...
  ILibRataDie newRdFromRd(double rd) {
    return PersianRataDie(rataDie: rd);
  }
