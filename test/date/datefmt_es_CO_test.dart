  ...
  group('format()', () {
    ...
    test('testDateFmtSimpleMedium_es_CO', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          millisecond: 0);
      final String result =
          (testPlatform == 'webOS') ? '29/Sep/2011' : '29/09/2011';
      expect(fmt.format(dateOptions), result);
    });
    ...
    test('testDateFmtDateTimeSimpleLong_es_CO', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          millisecond: 0);
      expect(
          fmt.format(dateOptions), '29 de septiembre de 2011 a las 1:45 p. m.');
    });
    ...
    test('testDateFmtShortDateComponentsWDM_es_CO', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          millisecond: 0);
      final String result =
          (testPlatform == 'webOS') ? 'JU, 29/Sep' : 'J, 29/09';
      expect(fmt.format(dateOptions), result);
    });
    test('testDateFmtShortDateComponentsWDMY_es_CO', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          millisecond: 0);
      final String result =
          (testPlatform == 'webOS') ? 'JU, 29/Sep/11' : 'J, 29/09/11';
      expect(fmt.format(dateOptions), result);
    });
    ...
    test('testDateFmtTemplateClock12SwitchHH_es_CO', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'es-CO', clock: '12', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock12Switchkk_es_CO', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'es-CO', clock: '12', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24SwitchKK_es_CO', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'es-CO', clock: '24', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24Switchhh_es_CO', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'es-CO', clock: '24', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
