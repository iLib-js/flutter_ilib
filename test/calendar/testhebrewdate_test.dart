...
void main() {
  debugPrint('Testing [testhebrewdate_test.dart] file.');
  ...
  group('HebrewDate from JD constructs correct date components', () {
    for (int i = 0; i < testDates.length; i++) {
      ...
      test('JD ${td[0]} gives year ${td[1]}, month ${td[2]}, day ${td[3]}', () {
        final HebrewDate d =
            HebrewDate(julianDay: td[0].toDouble(), timezone: 'Etc/UTC');
  ...
  group('HebrewDate constructor', () {
    ...
    test('testHebrewDateConstructorFromJD', () {
      final HebrewDate hd =
          HebrewDate(julianDay: 348354.5, timezone: 'Etc/UTC');
      expect(hd.getRataDie(), 357.25);
      expect(hd.getYears(), 2);
      expect(hd.getMonths(), 7);
      expect(hd.getDays(), 3);
  ...
  group('HebrewDate convert', () {
    test('testHebrewDateConvert', () {
      for (int i = 0; i < testDates.length; i++) {
        ...
        final HebrewDate hd =
            HebrewDate(julianDay: td[0].toDouble(), timezone: 'Etc/UTC');
        expect(hd.getRataDie(), td[0].toDouble() - 347997.25);
  ...
  group('HebrewDate onOrBefore', () {
    ...
    test('testHebrewDateOnOrBeforeSun', () {
      final HebrewDate hd =
          HebrewDate(year: 5771, month: 9, day: 12, timezone: 'Etc/UTC');
  ...
  group('HebrewDate getWeekOfYear', () {
    ...
    test('testHebrewDateTestGetWeekOfYearPreviousYear', () {
      final HebrewDate hd =
          HebrewDate(year: 5781, month: 7, day: 1, timezone: 'Etc/UTC');
      expect(hd.getWeekOfYear(), 51);
    });
    test('testHebrewDateTestGetWeekOfYearLastWeekLeap', () {
      final HebrewDate hd =
          HebrewDate(year: 5784, month: 6, day: 29, timezone: 'Etc/UTC');
      expect(hd.getWeekOfYear(), 1);
    });
    test('testHebrewDateTestGetWeekOfYearLastWeekRegular1', () {
      final HebrewDate hd =
          HebrewDate(year: 5781, month: 6, day: 29, timezone: 'Etc/UTC');
      expect(hd.getWeekOfYear(), 1);
    });
    test('testHebrewDateTestGetWeekOfYearLastWeekRegular2', () {
      final HebrewDate hd =
          HebrewDate(year: 5782, month: 6, day: 29, timezone: 'Etc/UTC');
      expect(hd.getWeekOfYear(), 1);
    });
    test('testHebrewDateTestGetWeekOfYearLastWeekRegular3', () {
      final HebrewDate hd =
          HebrewDate(year: 5783, month: 6, day: 29, timezone: 'Etc/UTC');
      expect(hd.getWeekOfYear(), 51);
    });
    test('testHebrewDateTestGetWeekOfYearLastWeekRegular4', () {
      final HebrewDate hd =
          HebrewDate(year: 5785, month: 6, day: 29, timezone: 'Etc/UTC');
      expect(hd.getWeekOfYear(), 1);
    });
    test('testHebrewDateTestGetWeekOfYearLastWeekRegular5', () {
      final HebrewDate hd =
          HebrewDate(year: 5786, month: 6, day: 29, timezone: 'Etc/UTC');
      expect(hd.getWeekOfYear(), 51);
    });
    test('testHebrewDateTestGetWeekOfYearLastWeekRegular6', () {
      final HebrewDate hd =
          HebrewDate(year: 5787, month: 6, day: 29, timezone: 'Etc/UTC');
  ...
  group('HebrewDate getDayOfYear', () {
    test('testHebrewDateGetDayOfYearFirstDay', () {
      final HebrewDate hd =
          HebrewDate(year: 5771, month: 7, day: 1, timezone: 'Etc/UTC');
    ...
    test('testHebrewDateGetDayOfYearMidYearLeap', () {
      final HebrewDate hd =
          HebrewDate(year: 5774, month: 1, day: 1, timezone: 'Etc/UTC');
      expect(hd.getDayOfYear(), 209);
    });
    test('testHebrewDateGetDayOfYearLastDay', () {
      final HebrewDate hd =
          HebrewDate(year: 5772, month: 6, day: 29, timezone: 'Etc/UTC');
      expect(hd.getDayOfYear(), 354);
    });
    test('testHebrewDateGetDayOfYearLastDayLeapYear', () {
      final HebrewDate hd =
          HebrewDate(year: 5774, month: 6, day: 29, timezone: 'Etc/UTC');
  ...
  group('HebrewDate getWeekOfMonth', () {
    ...
    test('testHebrewDateGetWeekOfMonth0', () {
      final HebrewDate hd =
          HebrewDate(year: 5772, month: 9, day: 1, timezone: 'Etc/UTC');
      expect(hd.getWeekOfMonth('he-IL'), 1);
    });
    test('testHebrewDateGetWeekOfMonth1', () {
      final HebrewDate hd =
          HebrewDate(year: 5772, month: 9, day: 2, timezone: 'Etc/UTC');
      expect(hd.getWeekOfMonth('he-IL'), 1);
    });
    test('testHebrewDateGetWeekOfMonth2', () {
      final HebrewDate hd =
          HebrewDate(year: 5772, month: 9, day: 11, timezone: 'Etc/UTC');
      expect(hd.getWeekOfMonth('he-IL'), 2);
    });
    test('testHebrewDateGetWeekOfMonth3', () {
      final HebrewDate hd =
          HebrewDate(year: 5772, month: 9, day: 20, timezone: 'Etc/UTC');
      expect(hd.getWeekOfMonth('he-IL'), 3);
    });
    test('testHebrewDateGetWeekOfMonth4', () {
      final HebrewDate hd =
          HebrewDate(year: 5772, month: 9, day: 29, timezone: 'Etc/UTC');
      expect(hd.getWeekOfMonth('he-IL'), 5);
    });
    test('testHebrewDateGetWeekOfMonth5', () {
      final HebrewDate hd =
          HebrewDate(year: 5772, month: 1, day: 30, timezone: 'Etc/UTC');
      expect(hd.getWeekOfMonth('he-IL'), 5);
    });
    test('testHebrewDateGetWeekOfMonth6', () {
      final HebrewDate hd =
          HebrewDate(year: 5772, month: 4, day: 1, timezone: 'Etc/UTC');
      expect(hd.getWeekOfMonth('he-IL'), 0);
    });
    test('testHebrewDateGetWeekOfMonth7', () {
      final HebrewDate hd =
          HebrewDate(year: 5772, month: 5, day: 1, timezone: 'Etc/UTC');
      expect(hd.getWeekOfMonth('he-IL'), 0);
    });
    test('testHebrewDateGetWeekOfMonth8', () {
      final HebrewDate hd =
          HebrewDate(year: 5772, month: 6, day: 1, timezone: 'Etc/UTC');
      expect(hd.getWeekOfMonth('he-IL'), 1);
    });
    test('testHebrewDateGetWeekOfMonth9', () {
      final HebrewDate hd =
          HebrewDate(year: 5772, month: 7, day: 1, timezone: 'Etc/UTC');
      expect(hd.getWeekOfMonth('he-IL'), 0);
    });
  ...
  group('HebrewDate getEra', () {
    ...
    test('testHebrewDateGetEraBAM', () {
      final HebrewDate hd =
          HebrewDate(year: -46, month: 5, day: 1, timezone: 'Etc/UTC');
      expect(hd.getEra(), -1);
    });
    test('testHebrewDateGetEraAMYear1', () {
      final HebrewDate hd =
          HebrewDate(year: 1, month: 1, day: 1, timezone: 'Etc/UTC');
      expect(hd.getEra(), 1);
    });
    test('testHebrewDateGetEraBAMYear0', () {
      final HebrewDate hd =
          HebrewDate(year: 0, month: 12, day: 29, timezone: 'Etc/UTC');
      expect(hd.getEra(), -1);
    });
  });
  ...
  group('HebrewDate constructor edge cases', () {
    ...
    test('testHebrewDateAfterLeapYear', () {
      // Siv 1, 0004, 9:36am
      final HebrewDate hd =
          HebrewDate(julianDay: 349326.9, timezone: 'Etc/UTC');
    ...
    test('testHebrewDateAfterNoon', () {
      // Siv 1, 0004, 2:24pm
      final HebrewDate hd =
          HebrewDate(julianDay: 349327.1, timezone: 'Etc/UTC');
      expect(hd.getYears(), 4);
      expect(hd.getMonths(), 3);
      expect(hd.getDays(), 1);
  ...
  group('HebrewDate getTime', () {
    test('testHebrewDateTestGetTimeZero', () {
      ...
      final HebrewDate hd =
          HebrewDate(year: 5730, month: 10, day: 23, timezone: 'Etc/UTC');
      expect(hd.getTime(), 0);
    });
    test('testHebrewDateTestGetTimeZeroJD', () {
      final HebrewDate hd =
          HebrewDate(julianDay: 2440587.5, timezone: 'Etc/UTC');
      expect(hd.getTime(), 0);
    });
    ...
    test('testHebrewDateTestGetTimeTooEarly', () {
      final HebrewDate hd =
          HebrewDate(year: 5730, month: 10, day: 22, timezone: 'Etc/UTC');
      expect(hd.getTime(), -1);
    });
    test('testHebrewDateTestGetTimeTooLate', () {
      final HebrewDate hd =
          HebrewDate(year: 5798, month: 11, day: 14, timezone: 'Etc/UTC');
      expect(hd.getTime(), -1);
    });
  });
  ...
  group('HebrewDate round-trip construction', () {
    ...
    test('testHebrewDateRoundTripConstruction2', () {
      final HebrewDate hd = HebrewDate(
          year: 5775, month: 8, day: 10, timezone: 'America/Los_Angeles');
      final int u = hd.getTime();
      final HebrewDate hd2 =
          HebrewDate(unixtime: u, timezone: 'America/Los_Angeles');
      expect(hd2.getTimeZone(), hd.getTimeZone());
      expect(hd2.getYears(), hd.getYears());
      expect(hd2.getMonths(), hd.getMonths());
      expect(hd2.getDays(), hd.getDays());
