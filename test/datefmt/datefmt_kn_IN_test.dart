  ...
  group('format()', () {
    ...
    test('testDateFmtINDateTimeSimpleMedium_kn_IN', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          second: 0,
          millisecond: 0);
      expect(fmt.format(dateOptions), 'ಸೆಪ್ಟೆಂ 29, 2011, 01:45 PM');
    });
    test('testDateFmtINDateTimeSimpleLong_kn_IN', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          millisecond: 0);
      expect(
          fmt.format(dateOptions), 'ಸೆಪ್ಟೆಂಬರ್ 29, 2011 ರಂದು 01:45 PM ಸಮಯಕ್ಕೆ');
    });
    ...
    test('testDateFmtINTemplateClock12SwitchHH_kn_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'kn-IN', clock: '12', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateClock12Switchkk_kn_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'kn-IN', clock: '12', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateClock24Switchhh_kn_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'kn-IN', clock: '24', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateClock24SwitchKK_kn_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'kn-IN', clock: '24', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateNoClockDoNotFollowLocaleDefault12hh_kn_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'kn-IN', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateNoClockDoNotFollowLocaleDefault12KK_kn_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'kn-IN', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateNoClockDoNotFollowLocaleDefault24HH_kn_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'kn-IN', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateNoClockDoNotFollowLocaleDefault24kk_kn_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'kn-IN', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
