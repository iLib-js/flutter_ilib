...
void main() {
  ...
  group('format()', () {
    ...
    test('testDateFmtShortDateComponentsY_sl_SI', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'sl-SI', calendar: 'gregorian', date: 'y');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtShortDateComponentsM_sl_SI', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'sl-SI', calendar: 'gregorian', date: 'm');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtShortDateComponentsN_sl_SI', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'sl-SI', calendar: 'gregorian', date: 'n');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtShortDateComponentsD_sl_SI', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'sl-SI', calendar: 'gregorian', date: 'd');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
