...
void main() {
  ...
  group('format()', () {
    ...
    test('testDateFmtFullDateComponentsDM_mn_Cyrl_MN', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'mn-Cyrl-MN', length: 'full', date: 'dm');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtFullDateComponentsMY', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'mn-Cyrl-MN', length: 'full', date: 'my');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtFullDateComponentsDMY', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'mn-Cyrl-MN', length: 'full', date: 'dmy');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtFullDateComponentsWDM_mn_Cyrl_MN', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'mn-Cyrl-MN', length: 'full', date: 'wdm');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtShortTimeComponentsHMSA_mn_Cyrl_MN', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'mn-Cyrl-MN', type: 'time', time: 'hmsa');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
