...
void main() {
  ...
  group('format()', () {
    ...
    test('testDateFmtDateTimeSimpleLong_ar_EG', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'ar-EG', length: 'long', type: 'datetime');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtDateTimeSimpleFull_ar_EG', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'ar-EG', length: 'full', type: 'datetime');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtNativeSimpleLong_ar_EG', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'ar-EG', useNative: false, length: 'long');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtNativeSimpleFull_ar_EG', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'ar-EG', useNative: false, length: 'full');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
