...
void main() {
  ...
  group('format()', () {
    ...
    test('testDateFmtTemplateClock12SwitchHH_vi_VN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'vi-VN', clock: '12', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock12Switchkk_vi_VN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'vi-VN', clock: '12', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24SwitchKK_vi_VN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'vi-VN', clock: '24', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24Switchhh_vi_VN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'vi-VN', clock: '24', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockNotFollowLocaleDefault12KK_vi_VN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'vi-VN', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockNotFollowLocaleDefault12hh_vi_VN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'vi-VN', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockNotFollowLocaleDefault24HH_vi_VN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'vi-VN', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockNotFollowLocaleDefault24kk_vi_VN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'vi-VN', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
