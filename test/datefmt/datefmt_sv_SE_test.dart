...
void main() {
  ...
  group('format()', () {
    ...
    test('testDateFmtShortDateComponentsY_sv_SE', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'sv-SE', calendar: 'gregorian', date: 'y');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtShortDateComponentsM_sv_SE', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'sv-SE', calendar: 'gregorian', date: 'm');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtShortDateComponentsN_sv_SE', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'sv-SE', calendar: 'gregorian', date: 'n');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtShortDateComponentsD_sv_SE', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'sv-SE', calendar: 'gregorian', date: 'd');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
