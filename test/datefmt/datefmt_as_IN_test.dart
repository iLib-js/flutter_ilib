...
void main() {
  ...
  group('format()', () {
    ...
    test('testDateINDateTimeSimpleShort_as_IN', () async {
        ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: "as-IN", length: "short", type: "datetime");
        ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateINDateTimeSimpleMedium_as_IN', () async {
        ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: "as-IN", length: "medium", type: "datetime");
        ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateINDateTimeSimpleLong_as_IN', () async {
        ...
        expect(await fmt.format(dateOptions), "২৯ ছেপ্তেম্বৰ, ২০১১ at অপৰাহ্ন ১.৪৫");
    });
    ...
    test('testDateINFullTimeComponentsS_as_IN', () async {
        ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: "as-IN", type: "time", length: "full", time: "s");
        ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateINFullTimeComponentsM_as_IN', () async {
        ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: "as-IN", type: "time", length: "full", time: "m");
        ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateINFullTimeComponentsH_as_IN', () async {
        ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: "as-IN", type: "time", length: "full", time: "h");
        ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateINFullTimeComponentsHM_as_IN', () async {
        ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: "as-IN", type: "time", length: "full", time: "hma");
        ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateINFullTimeComponentsHMS_as_IN', () async {
        ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: "as-IN", type: "time", length: "full", time: "hmsa");
        ILibDateFmt fmt = ILibDateFmt(fmtOptions);
