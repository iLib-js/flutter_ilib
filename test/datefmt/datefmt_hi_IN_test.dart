...
void main() {
  ...
  setUpAll(() async {
    ...
    await ILibJS.instance.loadILibLocaleData('hi-IN');
  });
  group('format()', () {
    ...
    test('testDateFmtINTemplateClock12SwitchHH_hi_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'hi-IN', clock: '12', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateClock12Switchkk_hi_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'hi-IN', clock: '12', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateClock24SwitchKK_hi_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'hi-IN', clock: '24', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateClock24Switchhh_hi_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'hi-IN', clock: '24', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateNoClockDoNotFollowLocaleDefault12KK_hi_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'hi-IN', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateNoClockDoNotFollowLocaleDefault12hh_hi_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'hi-IN', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateNoClockDoNotFollowLocaleDefault24HH_hi_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'hi-IN', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtINTemplateNoClockDoNotFollowLocaleDefault24kk_hi_IN', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'hi-IN', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
