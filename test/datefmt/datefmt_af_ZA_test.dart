...
void main() {
  ...
  group('format()', () {
    ...
    test('testDateFmtShortDateComponentsY_af_ZA', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'af-ZA', calendar: 'gregorian', date: 'y');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtShortDateComponentsM_af_ZA', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'af-ZA', calendar: 'gregorian', date: 'm');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtShortDateComponentsN_af_ZA', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'af-ZA', calendar: 'gregorian', date: 'n');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtShortDateComponentsD_af_ZA', () {
      flutterIlibPlugin.addListener(() {
        final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
            locale: 'af-ZA', calendar: 'gregorian', date: 'd');
        final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
