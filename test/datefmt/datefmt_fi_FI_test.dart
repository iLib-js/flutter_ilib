...
void main() {
  ...
  group('format()', () {
    ...
    test('testDateFmtTemplateClock12SwitchHH_fi_FI', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'fi-FI', clock: '12', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock12Switchkk_fi_FI', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'fi-FI', clock: '12', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24SwitchKK_fi_FI', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'fi-FI', clock: '24', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24Switchhh_fi_FI', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'fi-FI', clock: '24', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault12KK_fi_FI', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'fi-FI', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault12hh_fi_FI', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'fi-FI', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault24HH_fi_FI', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'fi-FI', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault24kk_fi_FI', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'fi-FI', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
