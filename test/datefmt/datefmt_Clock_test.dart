...
void main() {
  ...
  setUpAll(() async {
    ...
    await ilibjsinstance.loadLocaleData('af');
    await ilibjsinstance.loadLocaleData('am');
    await ilibjsinstance.loadLocaleData('ar');
    await ilibjsinstance.loadLocaleData('as');
    await ilibjsinstance.loadLocaleData('az');
    await ilibjsinstance.loadLocaleData('bg');
    await ilibjsinstance.loadLocaleData('bn');
    await ilibjsinstance.loadLocaleData('bs');
    await ilibjsinstance.loadLocaleData('cs');
    await ilibjsinstance.loadLocaleData('da');
    await ilibjsinstance.loadLocaleData('de');
    await ilibjsinstance.loadLocaleData('el');
    await ilibjsinstance.loadLocaleData('en');
    await ilibjsinstance.loadLocaleData('es');
    await ilibjsinstance.loadLocaleData('et');
    await ilibjsinstance.loadLocaleData('fa');
    await ilibjsinstance.loadLocaleData('fi');
    await ilibjsinstance.loadLocaleData('fr');
    await ilibjsinstance.loadLocaleData('ga');
    await ilibjsinstance.loadLocaleData('gu');
    await ilibjsinstance.loadLocaleData('ha');
    await ilibjsinstance.loadLocaleData('he');
    await ilibjsinstance.loadLocaleData('hi');
    await ilibjsinstance.loadLocaleData('hr');
    await ilibjsinstance.loadLocaleData('hu');
    await ilibjsinstance.loadLocaleData('id');
    await ilibjsinstance.loadLocaleData('is');
    await ilibjsinstance.loadLocaleData('it');
    await ilibjsinstance.loadLocaleData('ja');
    await ilibjsinstance.loadLocaleData('ka');
    await ilibjsinstance.loadLocaleData('kk');
    await ilibjsinstance.loadLocaleData('km');
    await ilibjsinstance.loadLocaleData('kn');
    await ilibjsinstance.loadLocaleData('ko');
    await ilibjsinstance.loadLocaleData('ku');
    await ilibjsinstance.loadLocaleData('lt');
    await ilibjsinstance.loadLocaleData('lv');
    await ilibjsinstance.loadLocaleData('mk');
    await ilibjsinstance.loadLocaleData('ml');
    await ilibjsinstance.loadLocaleData('mn');
    await ilibjsinstance.loadLocaleData('mr');
    await ilibjsinstance.loadLocaleData('ms');
    await ilibjsinstance.loadLocaleData('nb');
    await ilibjsinstance.loadLocaleData('nl');
    await ilibjsinstance.loadLocaleData('or');
    await ilibjsinstance.loadLocaleData('pa');
    await ilibjsinstance.loadLocaleData('pl');
    await ilibjsinstance.loadLocaleData('pt');
    await ilibjsinstance.loadLocaleData('ro');
    await ilibjsinstance.loadLocaleData('ru');
    await ilibjsinstance.loadLocaleData('si');
    await ilibjsinstance.loadLocaleData('sk');
    await ilibjsinstance.loadLocaleData('sl');
    await ilibjsinstance.loadLocaleData('sq');
    await ilibjsinstance.loadLocaleData('sr');
    await ilibjsinstance.loadLocaleData('sv');
    await ilibjsinstance.loadLocaleData('sw');
    await ilibjsinstance.loadLocaleData('ta');
    await ilibjsinstance.loadLocaleData('te');
    await ilibjsinstance.loadLocaleData('th');
    await ilibjsinstance.loadLocaleData('tr');
    await ilibjsinstance.loadLocaleData('uk');
    await ilibjsinstance.loadLocaleData('ur');
    await ilibjsinstance.loadLocaleData('uz');
    await ilibjsinstance.loadLocaleData('vi');
    await ilibjsinstance.loadLocaleData('zh');
  });
