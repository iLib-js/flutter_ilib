...
void main() {
  ...
  group('format()', () {
    ...
    test('testDateFmtTemplateClock12SwitchHH_el_GR', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'el-GR', clock: '12', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock12Switchkk_el_GR', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'el-GR', clock: '12', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24SwitchKK_el_GR', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'el-GR', clock: '24', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24Switchhh_el_GR', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'el-GR', clock: '24', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault12KK_el_GR', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'el-GR', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault12hh_el_GR', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'el-GR', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault24HH_el_GR', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'el-GR', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault24kk_el_GR', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'el-GR', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
