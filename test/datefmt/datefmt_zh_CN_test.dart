...
void main() {
  ...
  setUpAll(() async {
    ...
    await ILibJS.instance.loadILibLocaleData('zh-Hans-CN');
  });
  group('format()', () {
    ...
    test('testDateFmtTemplateClock12SwitchHH_zh_Hans_CN', () {
      final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
          locale: 'zh-Hans-CN', clock: '12', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock12Switchkk_zh_Hans_CN', () {
      final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
          locale: 'zh-Hans-CN', clock: '12', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24SwitchKK_zh_Hans_CN', () {
      final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
          locale: 'zh-Hans-CN', clock: '24', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24Switchhh_zh_Hans_CN', () {
      final ILibDateFmtOptions fmtOptions = ILibDateFmtOptions(
          locale: 'zh-Hans-CN', clock: '24', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault12KK_zh_Hans_CN',
        () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'zh-Hans-CN', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault12hh_zh_Hans_CN',
        () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'zh-Hans-CN', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault24HH_zh_Hans_CN',
        () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'zh-Hans-CN', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault24kk_zh_Hans_CN',
        () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'zh-Hans-CN', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
