...
void main() {
  ...
  setUpAll(() async {
    ...
    await ILibJS.instance.loadILibLocaleData('he-IL');
  });
  group('format()', () {
    test('testDateFmtSimpleShort_he_IL', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          millisecond: 0);
      final String result =
          (testPlatform == 'webOS') ? '29.9.2011' : '‏29.9.2011';
    ...
    test('testDateFmtShortDateComponentsDM_he_IL', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          second: 0,
          millisecond: 0);
      final String result = (testPlatform == 'webOS') ? '29.9' : '‏29.9';
      expect(fmt.format(dateOptions), result);
    });
    test('testDateFmtShortDateComponentsMY_he_IL', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          second: 0,
          millisecond: 0);
      final String result = (testPlatform == 'webOS') ? '9.2011' : '‏9.2011';
      expect(fmt.format(dateOptions), result);
    });
    ...
    test('testDateFmtShortDateComponentsWDM_he_IL', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          millisecond: 0);
      final String result =
          (testPlatform == 'webOS') ? 'ה׳ ,29.9' : 'ה׳, ‏29.9';
      expect(fmt.format(dateOptions), result);
    });
    test('testDateFmtShortDateComponentsWDMY_he_IL', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          millisecond: 0);
      final String result =
          (testPlatform == 'webOS') ? 'ה׳ ,29.9.2011' : 'ה׳, 29.9.2011';
      expect(fmt.format(dateOptions), result);
    });
    ...
    test('testDateFmtTemplateClock12SwitchHH_he_IL', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'he-IL', clock: '12', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock12Switchkk_he_IL', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'he-IL', clock: '12', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24SwitchKK_he_IL', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'he-IL', clock: '24', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24Switchhh_he_IL', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'he-IL', clock: '24', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault12KK_he_IL', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'he-IL', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault12hh_he_IL', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'he-IL', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault24HH_he_IL', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'he-IL', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault24kk_he_IL', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'he-IL', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
