...
void main() {
  ...
  group('format()', () {
    ...
    test('testDateFmtTemplateClock24SwitchKK_tr_TR', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'tr-TR', clock: '24', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockDoNotFollowLocaleDefault12KK_tr_TR', () {
      final ILibDateFmtOptions fmtOptions =
