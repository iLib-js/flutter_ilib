  ...
  group('format()', () {
    ...
    test('testDateFmtSimpleMedium_si_LK', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          second: 0,
          millisecond: 0);
      expect(fmt.format(dateOptions), '2011 බිනර 29');
    });
    ...
    test('testDateFmtDateTimeSimpleMedium_si_LK', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          second: 0,
          millisecond: 0);
      expect(fmt.format(dateOptions), '2011 බිනර 29, 13.45');
    });
    test('testDateFmtDateTimeSimpleLong_si_LK', () {
      ...
      expect(fmt.format(dateOptions), '2011 බිනර 29 දින 13.45');
    });
    ...
    test('testDateFmtShortDateComponentsN_si_LK', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          second: 0,
          millisecond: 0);
      expect(fmt.format(dateOptions), 'බ');
    });
    ...
    test('testDateFmtFullDateComponentsDM_si_LK', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          second: 0,
          millisecond: 0);
      expect(fmt.format(dateOptions), 'බිනර 29');
    });
    test('testDateFmtFullDateComponentsMY_si_LK', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          second: 0,
          millisecond: 0);
      expect(fmt.format(dateOptions), '2011 බිනර');
    });
    ...
    test('testDateFmtFullDateComponentsDMW_si_LK', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          second: 0,
          millisecond: 0);
      expect(fmt.format(dateOptions), 'බිනර 29, බ්‍රහස්පතින්දා');
    });
    test('testDateFmtFullDateComponentsDMWY_si_LK', () {
      ...
      final ILibDateOptions dateOptions = ILibDateOptions(
          ...
          second: 0,
          millisecond: 0);
      expect(fmt.format(dateOptions), '2011 බිනර 29, බ්‍රහස්පතින්දා');
    });
    ...
    test('testDateFmtTemplateClock12SwitchHH_si_LK', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'si-LK', clock: '12', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock12Switchkk_si_LK', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'si-LK', clock: '12', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24SwitchKK_si_LK', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'si-LK', clock: '24', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateClock24Switchhh_si_LK', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'si-LK', clock: '24', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockNotFollowLocaleDefault12KK_si_LK', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'si-LK', template: 'KK:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockNotFollowLocaleDefault12hh_si_LK', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'si-LK', template: 'hh:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockNotFollowLocaleDefault24HH_si_LK', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'si-LK', template: 'HH:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
    ...
    test('testDateFmtTemplateNoClockNotFollowLocaleDefault24kk_si_LK', () {
      final ILibDateFmtOptions fmtOptions =
          ILibDateFmtOptions(locale: 'si-LK', template: 'kk:mm');
      final ILibDateFmt fmt = ILibDateFmt(fmtOptions);
